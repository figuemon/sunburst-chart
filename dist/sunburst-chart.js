...
(function(global, factory) {
    ...
    var sunburst = index$1({
        ...
        init: function init(domNode, state) {
            ...
            state.outerArc = d3Arc().startAngle(function(d) {
        ...
        update: function update(state) {
            ...
            /**
             * Create a Satellite Ring section
             * to indicate the distribution of changes in
             * a node
             * @param {*} d 
             */
            ...
            var strokeColorOf = index(state.strokeColor);
            index(state.outerColors);
